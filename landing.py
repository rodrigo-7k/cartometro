...
def landing_page():
    ...
    *,*::before,*::after{{margin:0;padding:0;box-sizing:border-box}}
    ...
    .lp-hero-bg::after{{content:'';position:absolute;top:0;left:0;width:60%;height:100%;background:linear-gradient(90deg,rgba(255,255,255,0.98) 0%,rgba(255,255,255,0.95) 35%,rgba(255,255,255,0.88) 55%,rgba(255,255,255,0.5) 75%,transparent 100%);z-index:1}}
    ...
    .lp-hero-p{{font-size:17px;color:#1f2937;line-height:1.7;margin-bottom:32px;max-width:500px}}
    .lp-hero-btns{{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:36px}}
    .lp-hero-trust{{display:flex;align-items:center;gap:20px;flex-wrap:wrap;font-size:13px;color:#4b5563}}
    ...
    .lp-plan-period{{font-size:13px;color:#4b5563;text-align:center;margin-bottom:24px}}
