    ...
    def renderizar_cards_cartoes():
        ...
        with ui.element('div').classes('cartoes-grid'):
            for cartao in cartoes_ordenados:
                ...
                # Card com estilo igual Configuracoes
                ...
                with ui.card().style(f'flex:1!important;min-width:0!important;padding:12px!important;background:#f9fafb!important;border-radius:10px!important;border:1px solid #f3f4f6!important;width:100%!important'):
                    with ui.row().classes('w-full items-center no-wrap').style('gap: 12px;'):
                        ...
                        with ui.element('div').style('flex: 0 0 auto; display: flex; justify-content: center;'):
                            if img_url:
                                ui.image(img_url).style('width: 56px; height: 36px; object-fit: contain; border-radius: 6px; border: 1px solid #e5e7eb; padding: 2px; flex-shrink: 0;')
                        ...
                        with ui.element('div').style('flex: 1; display: flex; flex-direction: column; gap: 2px;'):
                            ...
                            ui.label("À Vista " + formatar_moeda_br(limite_vista_cartao).replace(",00","") + " | Parcelado " + formatar_moeda_br(limite_parcelado_cartao).replace(",00","")).style('font-size:9px!important;color:#9ca3af!important;')
