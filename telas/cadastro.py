...
from db import carregar, adicionar_gasto
...
def tela_cadastro(callback=None):
    ...
    def campo_cartao():
        ...
        with ui.column().classes('w-full gap-1 campo-mobile'):
            ...
            cartao_display = ui.input(label="Cartão", value=nomes_cartoes[0]).props('outlined dense readonly').classes('w-full')
            cartao_value = {"valor": nomes_cartoes[0]}
